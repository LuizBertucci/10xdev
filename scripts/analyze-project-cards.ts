...
import { ProjectModel } from '../backend/src/models/ProjectModel'
import { CardQualitySupervisor, type QualityIssue } from '../backend/src/services/cardQualitySupervisor'
import type { CreateCardFeatureRequest } from '../backend/src/types/cardfeature'
