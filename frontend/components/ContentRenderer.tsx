    ...
    case ContentType.TEXT:
      return (
        <TextBlockContainer className={className}>
          <div className="break-words text-xs leading-relaxed [&_h1]:mb-2 [&_h1]:text-base [&_h1]:font-semibold [&_h2]:mb-2 [&_h2]:text-sm [&_h2]:font-semibold [&_h3]:mb-1 [&_h3]:text-sm [&_h3]:font-medium [&_h4]:mb-1 [&_h4]:text-xs [&_h4]:font-semibold [&_h5]:mb-1 [&_h5]:text-xs [&_h5]:font-semibold [&_h6]:mb-1 [&_h6]:text-xs [&_h6]:font-semibold [&_p]:mb-2 [&_p]:mt-0 [&_ul]:mb-2 [&_ul]:mt-1 [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:mb-2 [&_ol]:mt-1 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:my-0.5 [&_li>p]:m-0 [&_strong]:font-semibold [&_em]:italic [&_code]:rounded [&_code]:bg-gray-100 [&_code]:px-1 [&_code]:py-0.5">
            <ReactMarkdown>
              {block.content}
            </ReactMarkdown>
          </div>
