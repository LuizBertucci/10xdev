...
5. `.cursor/plans/feitos/análise_usar_code_blocks_para_conteúdo_3cdacf2d.plan.md` - Clarificar necessidade de `markdownContent`
6. `.cursor/plans/feitos/análise_usar_code_blocks_para_conteúdo_3cdacf2d.plan.md` - Enderecar PDF post edge case
7. `.cursor/plans/feitos/análise_usar_code_blocks_para_conteúdo_3cdacf2d.plan.md` - Adicionar testes de API e documentacao
