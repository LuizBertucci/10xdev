...
const CardFeatureModel_1 = require("@/models/CardFeatureModel");
class CardFeatureController {
    static async create(req, res) {
        try {
            ...
            const result = await CardFeatureModel_1.CardFeatureModel.create(data);
            if (!result.success) {
    ...
    static async getAll(req, res) {
        try {
            ...
            const result = await CardFeatureModel_1.CardFeatureModel.findAll(params);
            if (!result.success) {
                res.status(result.statusCode || 400).json({
                    success: false,
                    error: result.error
    ...
    static async getById(req, res) {
        try {
            ...
            const result = await CardFeatureModel_1.CardFeatureModel.findById(id);
            if (!result.success) {
                res.status(result.statusCode || 400).json({
                    success: false,
                    error: result.error
    ...
    static async search(req, res) {
        try {
            ...
            const result = await CardFeatureModel_1.CardFeatureModel.search(searchTerm, params);
            if (!result.success) {
                res.status(result.statusCode || 400).json({
                    success: false,
                    error: result.error
    ...
    static async getByTech(req, res) {
        try {
            ...
            const result = await CardFeatureModel_1.CardFeatureModel.findByTech(tech, params);
            if (!result.success) {
                res.status(result.statusCode || 400).json({
                    success: false,
                    error: result.error
    ...
    static async update(req, res) {
        try {
            ...
            const result = await CardFeatureModel_1.CardFeatureModel.update(id, data);
            if (!result.success) {
                res.status(result.statusCode || 400).json({
                    success: false,
                    error: result.error
    ...
    static async delete(req, res) {
        try {
            ...
            const result = await CardFeatureModel_1.CardFeatureModel.delete(id);
            if (!result.success) {
                res.status(result.statusCode || 400).json({
                    success: false,
                    error: result.error
    ...
    static async getStats(req, res) {
        try {
            const result = await CardFeatureModel_1.CardFeatureModel.getStats();
            if (!result.success) {
                res.status(result.statusCode || 400).json({
                    success: false,
                    error: result.error
    ...
    static async bulkCreate(req, res) {
        try {
            ...
            const result = await CardFeatureModel_1.CardFeatureModel.bulkCreate(items);
            if (!result.success) {
                res.status(result.statusCode || 400).json({
                    success: false,
                    error: result.error
    ...
    static async bulkDelete(req, res) {
        try {
            ...
            const result = await CardFeatureModel_1.CardFeatureModel.bulkDelete(ids);
            if (!result.success) {
                res.status(result.statusCode || 400).json({
                    success: false,
                    error: result.error
